...
def main():
    ...
    rsv=vectorial_model(idf_list,list_doc,request_list[10],4)
    
    print('RESULTAT : ',rsv)
    print('PERTINENT DOCS : ',pertinent_list[10])
    print('PRECISION : ',precision(pertinent_list[10],rsv.keys()))
    print('RECALL : ',recall(pertinent_list[10],rsv.keys()))
